...
import WeekActivitiesModal from '@/Components/Modals/Dashboard/WeekActivitiesModal';
...
export default function WeeklyGridSlide({ weeklyHistory }) {
    ...
    const handleWeekClick = (week) => {
        if (!week.activities || week.activities.length === 0) return;
        setSelectedActivities(week.activities);
        setSelectedWeek(week.week_label);
        setModalOpen(true);
    };
                            ...
                            return (
                                <div
                                    ...
                                    className={`
                                        ...
                                        ${!isZeroWeek ? 'cursor-pointer hover:scale-105' : ''}
                                    `}
