    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="bg-[#18181b] w-full max-w-lg rounded-3xl border border-gray-800 p-8 relative z-10 shadow-2xl">
                <button onClick={() => {onClose(); clearErrors()}} className="absolute top-4 right-4 text-gray-400 hover:text-white cursor-pointer">
                    <X size={24} />
                </button>
                ...
                <form onSubmit={submit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <label className="block border-2 border-dashed border-gray-700 rounded-xl p-4 text-center cursor-pointer hover:border-[#FC4C02] transition-colors">
                            <Upload className="mx-auto text-gray-500 mb-2" size={20} />
                            <span className="text-xs text-gray-400">{t('groups_upload_instruction')}</span>
                            <input
                                type="file"
                                className="hidden"
                    ...
                    <div className="pt-4 flex gap-3">
                        <button type="button" onClick={() => {onClose(); clearErrors()}} className="flex-1 py-3 rounded-xl border border-gray-700 text-gray-400 font-semibold hover:bg-white/5 transition-colors cursor-pointer">
                            {t('groups_cancel')}
                        </button>
