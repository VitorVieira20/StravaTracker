    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="bg-[#18181b] w-full max-w-5xl rounded-3xl shadow-2xl border border-gray-800 overflow-hidden relative z-10 flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 border-b border-gray-800 flex justify-between items-start bg-[#18181b] shrink-0">
                    <div>
                        ...
                        <div className="lg:col-span-2 min-h-75 h-full bg-[#27272a] rounded-3xl border border-gray-800 overflow-hidden relative shadow-inner flex flex-col">
                            {positions.length > 0 ? (
                                <MapContainer
                                    ...
                                    style={{ height: '100%', minHeight: '300px', width: '100%', background: '#18181b', flex: 1 }}
                                >
                                    <TileLayer
