...
export default function DashboardSideContent({ raceGoal, stravaData }) {
    ...
    useEffect(() => {
        ...
        const intervalId = setInterval(() => handleSync(), REFRESH_INTERVAL);
        ...
        <aside className="w-full lg:w-[30%] h-screen bg-[#000000] border-b lg:border-b-0 lg:border-r border-gray-800 flex flex-col justify-between p-6 lg:p-8 relative shrink-0 z-20">
            ...
            <div className="w-full">
                <Link
                    ...
                    method="post"
                    as="button"
                    className="flex items-center justify-center gap-2 w-full text-white bg-red-600/80 hover:bg-red-600/60 px-4 py-3 lg:py-2 rounded-2xl transition-all duration-300 text-sm lg:text-lg font-medium uppercase tracking-wider group cursor-pointer mt-3"
                >
